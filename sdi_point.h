...
public:
    ...
    static double distance(const SDI_Point& p1, const SDI_Point& p2); // calculate the distance between two point in the system coordinate machine
    static double distanceFromPointToLine(const SDI_Point& point, const SDI_Point& lineP1, const SDI_Point& lineP2);
